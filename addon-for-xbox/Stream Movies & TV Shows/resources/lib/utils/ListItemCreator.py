...
def BasicMovieListItem(dict):
    ...
    item.setProperty("id", str(dict.get('id')))
...
def FullMovieListItem(entity):
    ...
    item.setProperty("id", str(entity.id))
    ...
    item.setProperty("vote_average", str(entity.vote_average))
    item.setProperty("vote_count", str(entity.vote_count))
...
def FullTvShowListItem(entity):
    ...
    item.setProperty('runtime', str(entity.episode_run_time[0]))
    ...
    item.setProperty('number_of_episodes', str(entity.number_of_episodes))
    item.setProperty('number_of_seasons', str(entity.number_of_seasons))
    item.setProperty('overview', entity.overview)
    item.setProperty('seasons', str(entity.seasons))
    item.setProperty('vote_average', str(entity.vote_average))
...
def EpisodeListItem(entity):
    ...
    item.setProperty('name', entity.name)
    item.setProperty('overview', entity.overview)
    item.setProperty('episode_number', str(entity.episode_number))
    item.setProperty('season_number', str(entity.season_number))
...
def StreamListItem(entity):
    ...
    item.setProperty('title', entity.title)
    item.setProperty('seeds', str(entity.seeds))
    item.setProperty('peers', str(entity.peers))
    item.setProperty('size', str(entity.size))
